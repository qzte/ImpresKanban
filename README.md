...
**Versão atual:** 4.11.4 — servida como `index.html` (cópia versionada: `kanban-kpi-analyzer-v4_11_4.html`)
...
git add index.html kanban-kpi-analyzer-v4_11_4.html versao.md README.md

# 3. Commit com mensagem descritiva
git commit -m "fix(responsivo): separadores partiam o layout em telemóvel | kanban-kpi-analyzer-v4_11_4.html"

# 4. Enviar para GitHub
git push

# 5. Criar tag de versão
git tag -a v4.11.4 -m "Descrição curta da alteração"
git push origin v4.11.4
```
